...
class LunarLanderContinuousRule:
    def __init__(self):
        self.rule_dict = {
            0: [[self.s_no, self.s_no, self.s_no, self.s_no, self.s_no, self.s_no, self.a0_no]],
            1: [[self.s_any, self.s_any, self.s_any, self.s_any, self.s4_ne, self.s5_ne, self.a1_left],
                [self.s0_po, self.s_any, self.s_any, self.s_any, self.s4_sm, self.s_any, self.a1_left],
                [self.s_any, self.s_any, self.s_any, self.s_any, self.s4_po, self.s5_po, self.a1_right],
                [self.s0_ne, self.s_any, self.s_any, self.s_any, self.s4_sm, self.s_any, self.a1_right]]}

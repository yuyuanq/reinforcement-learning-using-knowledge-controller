...
if __name__ == '__main__':
    ...
    p.add_argument('--max_update', type=int, default=4000, help='Max update count for training')
    p.add_argument('--save_interval', type=int, default=1000, help='The save interval during training')
